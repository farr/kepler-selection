...
\begin{abstract}
  ...
  $\etaearth = \earange$ (90\% CL), in contrast to
  Ref.\ \cite{Petigura2013} but rough agreement with the analysis of
  the same data set in Ref.\ \cite{Foreman-Mackey2014}.  Also in
  contrast to Ref.\ \cite{Petigura2013}, we can conclude that each
  ...
  $\fposrange$ (90\% CL) of the candidates being false-positives.
\end{abstract}
